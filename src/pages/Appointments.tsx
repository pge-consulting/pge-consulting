...
export default function Appointments() {
  ...
  const discussionTopics = [
    "Current project status and key challenges",
    "Timeline, budget, and scope concerns",
    "Contractor performance and coordination issues",
    "Commissioning readiness and startup planning",
    "Technical risks and mitigation strategies",
    "How PGE Consulting can support your goals",
  ];
                  ...
                  <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        placeholder="Tell us about your project — current status, key challenges, timeline..."
                        rows={4}
                        className="mt-2"
                      />
                      {errors.description && (
